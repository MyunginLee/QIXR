...
public class Entanglement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numberOfSphere; i++)
        {
            ...
            strings[i].transform.position = new Vector3(r * Mathf.Cos(Mathf.PI * 2 / numberOfSphere * i), r * Mathf.Sin(Mathf.PI * 2 / numberOfSphere * i), Random.Range(-10, 10));
            ...
            trailRenderer.startWidth = 0.01f;  // Width of the trail at the start
            trailRenderer.endWidth = 0.01f;    // Width of the trail at the end
            ...
            gradient.SetKeys(
                ...
                new GradientColorKey[] { new GradientColorKey(new Color(0f,0f, 0f), 0f), new GradientColorKey(new Color((Mathf.Cos(Mathf.PI * 2 / numberOfSphere * i) + 1) / 3f, 0.2f - (Mathf.Cos(Mathf.PI * 2 / numberOfSphere * i) / 1.5f), 0.3f+(Mathf.Sin(Mathf.PI * 2 / numberOfSphere * i) + 1) / 3f), 0.05f) },
